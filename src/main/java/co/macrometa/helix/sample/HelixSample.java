...
public class HelixSample {

    // docker run --name helix-zookeeper --restart always -d -p 2181:2181 -p 8080:8080 zookeeper
    // or remote zookeeper URL
    private static String ZK_ADDRESS = "0.0.0.0:2181";
    private static String CLUSTER_NAME = "HELIX_CLUSTERING_SAMPLE";
    ...
    static {
        ...
        PROCESS_LIST = new ArrayList<HelixSample.MyProcess>();
